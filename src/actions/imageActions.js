...
export const fetchImages = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get('https://api.unsplash.com/photos/?per_page=10&client_id=K67EJLz8oKz7FeQiWLmdVFouPnqRcNswQkv55zwX5X8');
...
export const searchImages = (query) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`https://api.unsplash.com/search/photos/?per_page=10&query=${query}&client_id=K67EJLz8oKz7FeQiWLmdVFouPnqRcNswQkv55zwX5X8`);
